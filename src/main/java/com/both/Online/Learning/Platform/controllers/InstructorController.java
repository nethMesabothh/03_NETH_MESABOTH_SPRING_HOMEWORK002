...
public class InstructorController {
  ...
  @GetMapping
  public ResponseEntity<APIResponseInstructor<List<Instructor>>> getAllInstructors(@RequestParam(defaultValue = "1") Integer page, @RequestParam(defaultValue = "10") Integer size) {
